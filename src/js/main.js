...
const tabsCardModal = document.getElementById('.tabs__card');
...
/* card */
function modalCard() {
    tabsCardMobil.classList.toggle('active');
    tabsCard.classList.toggle('active');
}
tabsCard.addEventListener('click', modalCard);

tabsCardModal.addEventListener('click', () => {
